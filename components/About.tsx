...
export const About: React.FC = () => {
  ...
  return (
    <section className="w-full bg-black py-24 border-t border-gray-900 relative overflow-hidden">
      {/* Toast Notification */}
      <div
        className={`fixed bottom-8 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 px-4 py-2 bg-white text-black rounded-full shadow-2xl transform transition-all duration-300 ${
          showToast
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-10 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 font-light max-w-2xl mx-auto">
            Software Engineer & Architect based in Boston, specializing in
            scalable AI solutions and production-grade systems.
          </p>
        </div>

        {/* TLDR Block */}
        <div className="bg-[#0a0a0a] border-l-2 border-white p-8 mb-16 relative">
          <span className="absolute top-0 right-0 p-4 text-[10px] font-bold tracking-widest text-gray-600 uppercase">
            TL;DR
          </span>
        ...
        <div className="space-y-12">
          <div className="space-y-6 text-lg text-gray-400 font-light leading-relaxed">
            ...
            <p>
              I’m a software engineer building production-grade AI systems: from
              backend foundations to large-scale LLM platforms.
            </p>
            <p>
              Over 4+ years, I’ve worked across backend engineering, data
              pipelines, and applied ML, and I currently serve as a Tech Lead at
              QuantUniversity, where I design and ship LLM-powered systems used
              in real-world financial and educational products.
            </p>
          </div>
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-300 font-light">
                  RAG pipelines, agents, and tool routing
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Terminal className="w-5 h-5 text-gray-600 mt-1 flex-shrink-0" />
                <span className="text-gray-300 font-light">
                  Prompt versioning, fallback strategies, and observability
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Zap className="w-5 h-5 text-gray-600 mt-1 flex-shrink-0" />
                <span className="text-gray-300 font-light">
                  Cost-aware model selection (50–65% inference cost reduction)
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Server className="w-5 h-5 text-gray-600 mt-1 flex-shrink-0" />
                <span className="text-gray-300 font-light">
                  CI/CD and zero-downtime, multi-server deployments
                </span>
              </li>
              <li className="flex items-start gap-3">
                <ShieldCheck className="w-5 h-5 text-gray-600 mt-1 flex-shrink-0" />
                <span className="text-gray-300 font-light">
                  Bias auditing and compliance tooling (NYC Local Law 144)
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            <p className="text-lg text-gray-400 font-light">
              I’ve owned systems end to end{" "}
              <span className="text-gray-600 mx-2">→</span>{" "}
              <span className="text-white border-b border-gray-800 pb-0.5">
                APIs, background workers, real-time pipelines, and data
                workflows.
              </span>
            </p>
