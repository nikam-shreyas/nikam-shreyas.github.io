...
export const Experience: React.FC = () => {
  ...
  const handleItemClick = (e: React.MouseEvent<HTMLDivElement>, experience: ExperienceItem) => {
    ...
    <section className="w-full min-h-[60vh] bg-black py-24 border-t border-gray-900 relative flex flex-col justify-center overflow-hidden">
      ...
      <div className="px-6 md:px-20 mb-20 text-center relative z-10">
        ...
        <p className="text-gray-400 font-light max-w-2xl mx-auto">
           A chronological journey through my professional roles, leadership experiences, and technical contributions.
        </p>
      </div>

      {/* Scroll Indicator (Visual Cue) */}
      <div className="absolute right-8 top-1/2 -translate-y-1/2 z-30 hidden md:flex flex-col items-center gap-4 animate-bounce pointer-events-none opacity-60">
                ...
                <React.Fragment key={experience.id}>
                  ...
                  {index < experienceData.length - 1 && (
                    <div className="flex gap-2 h-8 items-center justify-center mx-0 self-center -mt-28 opacity-30 select-none w-[40px]">
                       ...
                       {[...Array(3)].map((_, i) => (
                          <div key={i} className="w-[1px] h-3 bg-gray-600 rounded-full" />
                       ))}
                    </div>
                  )}
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                  <div>
                    <h5 className="text-xs text-gray-500 uppercase tracking-widest mb-3">Focus</h5>
                  ...
                  <div>
                    <h5 className="text-xs text-gray-500 uppercase tracking-widest mb-3">Tech Stack</h5>
                    <div className="flex flex-wrap gap-2">
                      {selectedExperience.technologies.map(tech => (
                        <span key={tech} className="px-2 py-1 bg-gray-900 border border-gray-800 text-gray-400 text-xs rounded hover:border-gray-600 transition-colors cursor-default">
                          {tech}
                        </span>
                      ))}
                    </div>
