...
export const VolunteeringDetail: React.FC<VolunteeringDetailProps> = ({ post, onBack }) => {
        ...
        <section className="w-full min-h-screen bg-black py-24 border-t border-gray-900 relative">
             <div className="max-w-3xl mx-auto px-6 relative z-10">
                 ...
                 <header className="mb-12">
                    <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full border text-xs font-bold uppercase tracking-wider mb-6 ${colorClasses[post.color]}`}>
                 ...
                 <div className="mt-16 pt-8 border-t border-gray-800 flex justify-between items-center">
                    ...
                    <button className="p-2 rounded-full bg-gray-900 text-gray-400 hover:text-white hover:bg-gray-800 transition-colors cursor-not-allowed">
